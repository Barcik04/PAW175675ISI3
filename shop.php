...
<section style="max-width: 1100px; margin: 20px auto; padding: 12px;">
    <h1>Sklep — koszyk na sesji</h1>
    <p>Dodawaj produkty, aktualizuj ilość lub usuń je z koszyka. Wszystkie dane koszyka są przechowywane w tablicy <code>$_SESSION['cart']</code>.</p>

    <?php if ($errors): ?>
        <div style="color: #b91c1c; padding: 8px 12px; border: 1px solid #fca5a5; margin-bottom: 10px;">
    ...
    <?php if ($messages): ?>
        <div style="color: #065f46; padding: 8px 12px; border: 1px solid #6ee7b7; margin-bottom: 10px;">
        ...
        <table style="width: 100%; border-collapse: collapse;">
            ...
            <?php foreach ($products as $product): ?>
                <tr style="border-bottom: 1px solid #f1f5f9;">
                    ...
                    <td><?php echo htmlspecialchars($product['availability_status'], ENT_QUOTES); ?></td>
                    <td>
